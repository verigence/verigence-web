...
export async function getBookingPart1(
  ...
  // Opening Booking is an Audit Core read only. Do not prepare DI storage context
  // here. DI context is intentionally lazy and is prepared by the upload path only
