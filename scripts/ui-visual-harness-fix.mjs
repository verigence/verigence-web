...
if (!source.includes("duplicateBookingDetails.setAttribute('aria-label', 'Booking Details form section')")) {
  throw new Error('Responsive Booking Details selector disambiguation was not installed.');
}
