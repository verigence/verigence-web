...
if (!source.includes("detailsHeading.setAttribute('aria-label', 'Required Booking Fields')")) {
  throw new Error('Responsive Booking Details heading alias was not installed.');
}
